...
#         response = self.client.get(self.get_docs_url, {'data_type': 'some_type', 'document_state': 'some_state', 'member': 'some_member', 'portfolio': 'some_portfolio', 'source': 'web'}) 
#         self.assertEqual(response.status_code,status.HTTP_200_OK)
   

# class DocumentLinkViewTestCase(TestConfig):
#     def test_invalid_document_id(self):
#         url = reverse('document_link', kwargs={'document_id': 'invalid_id'})  # Replace 'document_link' with your actual URL name
