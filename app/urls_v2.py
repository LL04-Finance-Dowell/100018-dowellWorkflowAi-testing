...
urlpatterns = [
    ...
    path("processes/<str:process_id>/user-link/", views_v2.ProcessLink.as_view()),
    ...
    path(
        "processes/<str:company_id>/processes/",
    ...
    path(
        "documents/<str:company_id>/documents/",
    ...
    path("bookmarks/<str:company_id>/favourites/", views_v2.Bookmark.as_view()),
    path("templates/", views_v2.NewTemplate.as_view(), name="create_template"),
    path(
        "templates/<str:template_id>/object/",
