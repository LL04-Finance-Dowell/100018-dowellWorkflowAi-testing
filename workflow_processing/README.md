...
```
{
    ...
    "action": #refer (processing_action),
    "workflows": [
        {
            "workflows":
            {
...
steps = [
{
    ...
    "stepPublicMembers": [{ member: "user_name", "porfolio": "member_portfolio"}],
    "stepTeamMembers": [{ member: "user_name", "porfolio": "member_portfolio"}],
    "stepUserMembers": [{ member: "user_name", "porfolio": "member_portfolio"}],
    ...
    "stepDocumentCloneMap": [{"user_name": "document_id"}] # leave this out/ just assign an empty string
}
]
