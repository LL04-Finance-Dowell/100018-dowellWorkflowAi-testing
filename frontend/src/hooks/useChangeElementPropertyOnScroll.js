...
export default function useChangeElementPropertyOnScroll (referenceToElement, propertyToChange, valueToChangeToOnScrollUp, valueToChangeToOnScrollDown, boundaryHeight) {
    ...
    useEffect( () => {
        const checkScrollDirection = (e) => {
            ...
            // if 'boundaryHeight' parameter was passed
            if (boundaryHeight){
    ...
    }, [referenceToElement, currentHeight, propertyToChange, valueToChangeToOnScrollDown, valueToChangeToOnScrollUp, boundaryHeight])
};