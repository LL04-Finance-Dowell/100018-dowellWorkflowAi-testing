...
const AssignTime = ({ currentStepIndex }) => {
  ...
  const { limit, start_time, end_time } = watch();
  ...
  useEffect(() => {
    ...
    if (limit === "within_1_hour" || limit === "within_8_hours" || limit === "within_24_hours" || limit === "within_3_days" || limit === "within_7_days") return setEndTimeReadOnly(true);
  ...
  useEffect(() => {
    ...
    const currentLimitObj = limitTimes.find(time => time.normalValue === limit)
...
export const limitTimes = [
  ...
  { id: uuidv4(), option: "Within 1 hour", normalValue: "within_1_hour", hourValue: 1 },
  { id: uuidv4(), option: "Within 8 hour", normalValue: "within_8_hours", hourValue: 8 },
  { id: uuidv4(), option: "Within 24 hour", normalValue: "within_24_hours", hourValue: 24 },
  { id: uuidv4(), option: "Within 3 days", normalValue: "within_3_days", hourValue: 72 },
  { id: uuidv4(), option: "Within 7 days", normalValue: "within_7_days", hourValue: 168 },
